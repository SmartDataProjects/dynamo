function initPage(graph,src_filter,no_mss,period,upto,exit_code)
{
  var jaxInput = {
    'url': dataPath + '/deletions/history',
    'data': { 'graph': graph,
    ...
    'dataType': 'json',
    'success': function (data, textStatus, jqXHR) { displayHistogram(graph,data.data); },
    'error': handleError,
    'async': false
  };
  $.ajax(jaxInput);
...
function displayHistogram(graph,data)
{
  // defaults
