class CopyInterface(object):
    ...
    def schedule_copy(self, dataset_replica, comments = '', is_test = False):
        """
    ...
    def schedule_copies(self, replica_list, comments = '', is_test = False):
        """
        ...
        for replica in replica_list:
            operation_id = self.schedule_copy(replica, comments, is_test = is_test)
